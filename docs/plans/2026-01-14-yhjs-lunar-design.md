...
| 任务 | 文件 | 状态 |
|------|------|------|
| 实朔实气计算 (SSQ) | `lunar/solar-term.ts` | ⏳ |
| 朔望计算 | `lunar/calendar.ts` | ⏳ |
| 干支计算 | `lunar/gan-zhi.ts` | ⏳ |
| 节日数据 | `lunar/festival.ts` | ⏳ |
| LunarDate 核心类 | `lunar/lunar-date.ts` | ⏳ |
...
| 任务 | 文件 | 状态 |
|------|------|------|
| 月食计算 | `eclipse/lunar-eclipse.ts` | ⏳ |
| 日食计算 | `eclipse/solar-eclipse.ts` | ⏳ |
